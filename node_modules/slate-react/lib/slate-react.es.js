...
var DELETE_LINE_BACKWARD_MAC = isKeyHotkey('cmd+backspace');
...
var DELETE_WORD_BACKWARD_MAC = isKeyHotkey('option+backspace');
var DELETE_WORD_BACKWARD_PC = isKeyHotkey('ctrl+backspace');
var DELETE_WORD_FORWARD_MAC = isKeyHotkey('option+delete');
