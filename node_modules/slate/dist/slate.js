...
var IS_DEV$1 = typeof process$1 !== 'undefined' && process$1.env && "development" !== 'production';
  ...
  createClass(Text, [{
    ...
    value: function addMarks(index$$1, length, set$$1) {
      var characters = this.characters.map(function (char, i) {
        if (i < index$$1) return char;
        if (i >= index$$1 + length) return char;
        var _char = char,
            marks = _char.marks;
    ...
    value: function getDecoratedCharacters(decorations) {
      ...
      decorations.forEach(function (range) {
        ...
        var length = hasEnd ? endOffset - index$$1 : characters.size;
        node = node.addMarks(index$$1, length, marks);
      });
    ...
    value: function getMarksAtIndex(index$$1) {
      if (index$$1 == 0) return Mark.createSet();
      var characters = this.characters;

      var char = characters.get(index$$1 - 1);
    ...
    key: 'insertText',
    value: function insertText(index$$1, text, marks) {
      var characters = this.characters;
      ...
      characters = characters.slice(0, index$$1).concat(chars).concat(characters.slice(index$$1));
    ...
    key: 'removeText',
    value: function removeText(index$$1, length) {
      var characters = this.characters;
  ...
  createClass(Node, [{
    ...
    value: function mapDescendants(iterator) {
      ...
      nodes.forEach(function (node, i) {
        ...
        var index$$1 = nodes.indexOf(node);
    ...
    value: function removeDescendant(key) {
      ...
      var nodes = parent.nodes.splice(index$$1, 1);
    ...
    value: function removeNode(index$$1) {
      var nodes = this.nodes.splice(index$$1, 1);
      return this.set('nodes', nodes);
    }
...
memoize(Stack$2.prototype, ['getPluginsWith'], {
  takesArguments: true
});
