...
import WaterLevelMonitor from './pages/WaterLevelMonitor';
import WxWaterLevelMonitor from './pages/WxWaterLevelMonitor';
import JinseNews from './pages/JinseNews';
...
const autoGeneratedRoutes = [
  {
    ...
    indexRoute: { component: JinseNews },
  },
  {
    path: '/login',
    childRoutes: [],
  ...
  },
  {
    ...
    childRoutes: [
      ...
      {
        path: 'waterLevelMonitor',
        childRoutes: [],
        component: WaterLevelMonitor,
      },
      {
        path: 'wxWaterLevelMonitor',
        childRoutes: [],
        component: WxWaterLevelMonitor,
      },
    ],
    component: HeaderAsideFooterResponsiveLayout,
